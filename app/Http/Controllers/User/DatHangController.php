...
class DatHangController extends Controller
{
    ...
    public function lichSuDatHang(Request $req){
        $pageInfo = [
            'page'  => $this->page
        ];
        ...
        $chitiethoadon= ChiTietHoaDon::with('chi_tiet_sp')->where('id',$req->id)->first();
        $hoadon = $hoadon->orderBy('ma_hd') ->paginate($this->limit);
        return view('user.page.lich-su-dat-hang.lichsudathang', compact('hoadon','chitiethoadon'));
    }
}
