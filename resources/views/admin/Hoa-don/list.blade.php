                            ...
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-3 form-group">
                                        ...
                                        <input type="text" id="ma_hd" name="ma_hd" class="form-control"
                                            @if (!empty($inputSearch['ma_hd'])) value="{{ $inputSearch['ma_hd'] }}" @endif
                                            maxlength="50">
                                    </div>
                                    <div class="col-3 form-group">
                                        <label>tổng tiền</label>
                                        <input type="text" id="tong_tien" name="tong_tien" class="form-control"
                                            @if (!empty($inputSearch['tong_tien'])) value="{{ $inputSearch['tong_tien'] }}" @endif
                                            maxlength="30">
                                    </div>
                                ...
                                <div class="row">
                                    <div class="col-12">
                                        <div class="d-flex justify-content-end">
                                            ...
                                            <a href="{{ route('Hoa-don.list') }}"
                                                class="mr-1 btn btn-secondary waves-effect waves-light"><i
                                                    class="fas fa-redo-alt"></i> Làm mới</a>
                ...
                <div class="card-body">
                    <div class="row">
                        <div class="col-8">
                            ...
                            <a href="{{ route('Hoa-don.statistic') }}" class="btn btn-info waves-effect waves-light mb-4"><i
                                    class="fas fa-file"></i> Thống kê</a>
                        </div>
                                ...
                                <tbody>
                                    ...
                                    @foreach ($hoadon as $hoadons)
                                        <tr>
                                            ...
                                            <td>
                                                <div>
                                                    <a href="{{ route('Hoa-don.edit', ['id' => $hoadons->id]) }}"
                                                        class="btn btn-warning btn-sm waves-effect waves-light"
                                                        data-toggle="tooltip" data-placement="top" title="Chỉnh sửa"><i
                                                            class="fas fa-edit"></i></a>

                                                    <a href="{{ route('Hoa-don.inhoadon', ['id' => $hoadons->id]) }}"
                                                        class="btn btn-warning btn-sm waves-effect waves-light"
                                                        data-toggle="tooltip" data-placement="top" title="In hóa đơn"><i
                                                            class="fas fa-print"></i></a>
                                                    <a href="javascript:void(0);"
                                                        class="btn btn-secondary btn-sm waves-effect waves-light btn-delete"
                                                        data-id="{{ $hoadons->id }}" data-title="{{ $hoadons->ma_hd }}"
