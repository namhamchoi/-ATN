                ...
                <div class="card-body">
                    <div class="row">
                        <div class="col-4 form-group">
                            <label>Mã hoá đơn @if (!isset($hoadon)) <span style="color: red">*</span> @endif </label>
                            <input type="text" name="ma_hd" id="ma_hd" class="form-control" required maxlength="50" placeholder="Nhập Mã hoá đơn" @isset($hoadon) value="{{ $hoadon->ma_hd }}" @endisset/>
                        </div>
                        <div class="col-4 form-group">
                        ...
                        <div class="col-2 form-group">
                            ...
                            <select name="tinh_trang" id="tinh_trang" class="form-control" required>
                                ...
                                @endif
                                <option @if (isset($hoadon) && $hoadon->tinh_trang == 0) selected @endif value="Đang vận chuyển">Đang vận chuyển</option>
                                <option @if (isset($hoadon) && $hoadon->tinh_trang == 1) selected @endif value="Đã giao">Đã giao hàng</option>
                            </select>
                        </div>
                    </div>
                    <div class="row mt-4">
