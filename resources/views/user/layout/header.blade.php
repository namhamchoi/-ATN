        ...
        <div class="rowx">
            <div class="col-lg-6 col-md-6 col-sm-6 hidden-xs top_content_">
                <ul class="contact_top">
                    ...
                    <li class="li_contact"><span><span class="ti ti-headphone-alt"></span> Hotline: <a href="tel:0868612957">0868612957</a></span>
                                        ...
                                        <div class="wrap_log">
                                            ...
                                            <div class="log">
                                                ...
                                                @if(Auth::check())
                                                    ...
                                                    <li><a class="text-color" href="history" title="Lịch sử đơn hàng">Lịch sử đơn hàng</a>
