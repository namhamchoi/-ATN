                                                ...
                                                <table class="total-line-table">
                                                    <!-- <caption class="visually-hidden">Tổng giá trị</caption>
                                                        ...
                                                        <tbody class="total-line-table__tbody">
                                                            ...
                                                            {{-- <tr class="total-line total-line--subtotal">
                                                                <th class="total-line__code">
                                                                    Mã giảm giá
                                                                </th>
                                                                <td class="total-line__price">3%</td>
                                                            </tr> --}}
                                                            <tr class="total-line total-line--datetime">
                                                                <th class="total-line__name">Ngày đặt</th>
                                                                <td class="total-line__datetime"> {{ date('d-m-Y')}} </td>
                                                            </tr>
                                                            {{-- <tr class="total-line total-line--discount code">
                                                                <th class="total-line__name">Mã giảm giá</th>
                                                                <td class="total-line__discount code"> 3% </td>
                                                            </tr> --}}
