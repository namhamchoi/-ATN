        ...
        <div class="col-md-12">
            ...
            <div class="row" style="background: cadeblue; padding: 15px">
                ...
                <div class="col-md-6" style="text-align: center; color: #000; font-weight: bold; font-size: 30px">
                    <h4 style="margin:0">Shop Thiết bị điện tử tin học Smarket.vn</h4>
                ...
                <div class="col-md-12">
                    ...
                    <table class="table table-striped" style="border: 1px">
                        ...
                        <tbody>
                            ...
                            @endforeach
                            {{-- <tr>
                                <td style="color:#000; font-weight: bold" colspan="4" align="right">Mã giảm giá: 3%</td>
                            </tr> --}}
                            <tr>
                                <br>
                ...
                <p style="color: #000; font-weight: bold">Mọi chi tiết liên hệ website tại: <a href="http://127.0.0.1:8000/">SMARKET.VN</a>, hoặc liên hệ qua số hotline: 0868612957. Xin cảm ơn quý khách đã mua hàng shop chúng tôi.</p>
            </div>
        </div>
    </div>
</body>
