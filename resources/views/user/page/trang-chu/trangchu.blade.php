...
@section('content')
        ...
        <section class="section_slider_banner">
            ...
            <div class="container">
                ...
                <div style="width:100%" class="slider-layout-1 col-md-12 col-sm-12 col-xs-12">
                    <div class="owl-carousel" data-nav="true" data-lg-items="1" data-md-items="1" data-height="false"
                        data-xs-items="1" data-sm-items="1" data-margin="0">
                        ...
                        @foreach ($slide as $sl)
                            <div class="item">
                                <a href="{{ $sl->link }}">
                                    <picture>
                                        <img style="height: 500px;"class="border-radius-10"
                                            src="assetsUser/images/{{ $sl->image }}" alt="slide {{ $sl->id }}" />
                                    </picture>
                                </a>
                            </div>
                        @endforeach
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12 ser">
                            <div class="wrap_ser">
                                ...
                                <div class="content_ser">
                                    <a href="chinhsachhanghieu">
                                        <p class="large_">HÀNG HIỆU 100%</p>
                                    </a>
                        ...
                        <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12 ser">
                            <div class="wrap_ser">
                                ...
                                <div class="content_ser">
                                    <a href="chinhsachdoitrabaohanh">
                                        <p class="large_">BẢO HÀNH TỐT</p>
                                    </a>
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 wrap_owl_product_">
                        <div class="owl_product_ owl-carousel" data-nav="true" data-lg-items="5" data-md-items="4"
                            data-height="false" data-xs-items="2" data-sm-items="3" data-margin="0">
                                    ...
                                    <div class="owl_item_product">
                                        ...
                                        <div class="product-box">
                                            <div class="product-thumbnail">
                                                ...
                                                @endif
                                                <a href="{{ route('chitietsanpham', $sps->id) }}"
                                                    class="image_link display_flex"
                                                    data-images="anh_sp/{{ $sps->san_pham->hinh_anh }}"
                                                    title="{{ $sps->ten_sp }}">
                                                    <img
                                                        class="img-responsive lazyload"
                                                        src="anh_sp/{{ $sps->san_pham->hinh_anh }}"
                                                        data-src="anh_sp/{{ $sps->san_pham->hinh_anh }}"
                                                        alt="{{ $sps->ten_sp }}" />
                                                ...
                                                <div class="product-action-grid clearfix">
                                                    ...
                                                    <div>
                                                        <button style="background: #ff8c04;border-radius: 25px "
                                                            class="button_wh_40 btn_view right-to xemnhanh"
                                                            data-toggle="modal" data-target="#xemNhanh"
                                                            data-id_product="{{ $sps->id }}"
                                                            data-id_img="{{ $sps->san_pham->id }}">
                                            ...
                                            <div class="product-info">
                                                ...
                                                <h3 class="product-name">
                                                    <a class="text2line" href="{{ route('chitietsanpham', $sps->id) }}"
                                                        title="{{ $sps->ten_sp }}">{{ $sps->ten_sp }}</a>
                                                </h3>
                                                ...
                                                <div class="price-box clearfix">
                                                    ...
                                                    <span
                                                        class="price product-price">{{ number_format($sps->gia * ((100 - $sps->giam_gia) / 100), 0, ',', '.') }}
                                                        đ</span>
                                                </div>
                                                    ...
                                                    @if ($sps->so_luong > 0)
                                                        <form action="{{ route('cart-add', $sps->id) }}" method="GET">
                                                            <div>
                                                                <input type="hidden" />
                                                                <button
                                                                    class=" cart_button_style btn-cart left-to add_to_cart"
                                        ...
                                        <div class="clockdiv" data-countdown="2022/10/10 15:00"></div>
                                    </div>
                                </div>
                            @endforeach
                        </div>
    ...
    <section class="awe-section-3">
        ...
        <link rel="preload" as="script"
            href="//bizweb.dktcdn.net/100/286/794/themes/637857/assets/jquery-cycle22.js?1618737291739" />
        <script src="//bizweb.dktcdn.net/100/286/794/themes/637857/assets/jquery-cycle22.js?1618737291739"
                ...
                <div class="row">
                    ...
                    <div class="tab-content">
                        ...
                        <div role="tabpanel" class="tab-pane active" id="tab21">
                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 wrap_owl_product_">
                                <div class="owl_product_ owl-carousel" data-nav="true" data-lg-items="5"
                                    data-md-items="4" data-height="false" data-xs-items="2" data-sm-items="3"
                                    data-margin="0">
                                        ...
                                        <div class="item saler_item first">
                                            <div class="owl_item_product">
                                                ...
                                                <div class="product-box">
                                                    <div class="product-thumbnail">
                                                        @if ($spm->so_luong == 0)
                                                            <img style="width:160px;" src="assetsUser/images/hethang.png">
                                                            </img>
                                                        @else
                                                            @if ($spm->giam_gia > 0)
                                                                <span class="sale_count"><span class="bf_">-
                                                            ...
                                                            @if ($spm->new == 0)
                                                                <img style="width:90px;" src="assetsUser/images/new.jpg">
                                                                </img>
                                                            @endif
                                                        @endif
                                                        ...
                                                        @if ($spm->so_luong > 0 && $spm->new != 0)
                                                            <img style="padding-bottom: 90px"></img>
                                                        @endif
                                                        <a href="{{ route('chitietsanpham', $spm->id) }}"
                                                            class="image_link display_flex"
                                                            data-images="anh_sp/{{ $spm->san_pham->hinh_anh }}"
                                                            title="{{ $spm->ten_sp }}">
                                                            <img
                                                                class="img-responsive lazyload"
                                                                src="anh_sp/{{ $spm->san_pham->hinh_anh }}"
                                                                data-src="anh_sp/{{ $spm->san_pham->hinh_anh }}"
                                                                alt="{{ $spm->ten_sp }}" />
                                                        </a>
                                                        <div class="product-action-grid clearfix">
                                                            ...
                                                            <div>
                                                                <button style="background: #ff8c04;border-radius: 25px "
                                                                    class="button_wh_40 btn_view right-to xemnhanh"
                                                                    data-toggle="modal" data-target="#xemNhanh"
                                                                    data-id_product="{{ $spm->id }}"
                                                                    data-id_img="{{ $spm->san_pham->id }}">
                                                                    <i style="color: #fff;"class="fa fa-search"></i>
                                                                    <span style="color: white">Xem nhanh</span>
                                                                </button>
                                                            </div>
                                                    ...
                                                    <div class="product-info">
                                                        ...
                                                        <div class="reviews-product-list grid_reviews">
                                                            <div class="bizweb-product-reviews-badge" data-id="9725087">
                                                            </div>
                                                        </div>

                                                        <h3 class="product-name"><a class="text2line"
                                                                href="{{ route('chitietsanpham', $spm->id) }}"
                                                                title="{{ $spm->ten_sp }}">{{ $spm->ten_sp }}</a></h3>
                                                        ...
                                                        <div class="price-box clearfix">
                                                            ...
                                                            <span
                                                                class="price product-price">{{ number_format($spm->gia * ((100 - $spm->giam_gia) / 100)) }}đ</span>
                                                        </div>


                                                        <div class="action__">
                                                            @if ($spm->so_luong > 0)
                                                                <form action="{{ route('cart-add', $spm->id) }}"
                                                                    method="GET">
                                                                    <div>
                                                                        <input type="hidden" />
                                                                        <button
                                                ...
                                                <div class="product-box">
                                                    <div class="product-thumbnail">
                                                        ...
                                                        <a href="{{ route('chitietsanpham', $sp->id) }}"
                                                            class="image_link display_flex"
                                                            data-images="anh_sp/{{ $sp->san_pham->hinh_anh }}"
                                                            title="{{ $sp->ten_sp }}">
                                                            <img
                                                                class="img-responsive lazyload"
                                                                src="anh_sp/{{ $sp->san_pham->hinh_anh }}"
                                                                data-src="anh_sp/{{ $sp->san_pham->hinh_anh }}"
                                                                alt="{{ $sp->ten_sp }}" />
                                                    ...
                                                    <div class="product-info">
                                                        ...
                                                        <h3 class="product-name"><a class="text2line"
                                                                href="{{ route('chitietsanpham', $sp->id) }}"
                                                                title="{{ $sp->ten_sp }}">{{ $sp->ten_sp }}</a></h3>
                                                        ...
                                                        <div class="price-box clearfix">
                                                            @if ($sp->giam_gia > 0)
                                                                ...
                                                                <span
                                                                    class="price product-price">{{ number_format($sp->gia * ((100 - $sp->giam_gia) / 100), 0, ',', '.') }}
                                                                    đ</span>
                                                            @else
                                                        ...
                                                        <div class="action__">
                                                            @if ($sp->so_luong > 0)
                                                                <form action="{{ route('cart-add', $sp->id) }}"
                                                                    method="GET">
                                                                    <div>
                                                                        <input type="hidden" />
                                                                        <button
